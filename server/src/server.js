...
app.use("/api/v1/equipment-types", equipmentTypeRoutes);
...
app.listen(PORT, () => {
  ...
  console.log(`Personal:  http://localhost:${PORT}/api/v1/personnel`);
  console.log(`Tipos equipo: http://localhost:${PORT}/api/v1/equipment-types`);
  console.log("======================================");
  console.log("");
});
